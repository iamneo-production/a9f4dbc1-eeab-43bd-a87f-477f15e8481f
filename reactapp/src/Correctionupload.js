...
function Correctionupload() {
  ...
  return (
    <div className='main'>
        ...
        <div style={{marginBottom:"20px"}}><a href="/correctionform/1" className="asd3 nav-links">1</a>{" "}<a href="/correctionform/2" className="asd2 nav-links">2</a></div>
...
export default Correctionupload
